...
while camera.isOpened():
    ...
    if isBgCaptured == 1:  # this part wont run until background captured
        ...
        if length > 0:
            ...
            if triggerSwitch is True:
                print(hasTakenOff,landCount,takeOffCount)
    ...
    if k == 27:  # press ESC to exit
        ...
        bgModel = cv2.createBackgroundSubtractorMOG2(0, bgSubThreshold) #this is where error is occuring
        isBgCaptured = 1
